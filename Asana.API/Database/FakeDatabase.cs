...
namespace Asana.API.Database
{
    public class FakeDatabase
    {
        ...
        private FakeDatabase() {
            ...
            toDos = new List<ToDo>
                {
                    new ToDo{Id = 1, Name = "Task 1", Description = "My Task 1", IsCompleted=true, ProjId =1},
                    new ToDo{Id = 2, Name = "Task 2", Description = "My Task 2", IsCompleted=false, ProjId = 1 },
                    new ToDo{Id = 3, Name = "Task 3", Description = "My Task 3", IsCompleted=true , ProjId = 1},
                    new ToDo{Id = 4, Name = "Task 4", Description = "My Task 4", IsCompleted=false , ProjId = 2},
                    new ToDo{Id = 5, Name = "Task 5", Description = "My Task 5", IsCompleted=true , ProjId = 3}
                };
